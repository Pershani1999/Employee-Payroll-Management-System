												...
												<div class="row">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="branch_name" id="branch_name" value="<?php echo $data['branch_name']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
													...
													<div class="col-lg-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="epf_account" id="epf_account" value="<?php echo $data['epf_account']; ?>" required />
														</div>
													</div>
													<div class="col-lg-3">
														<div class="form-group">
															<label for="etf_account">ETF A/C No.</label>
															<input type="text" class="form-control" name="etf_account" id="etf_account" value="<?php echo $data['etf_account']; ?>" required />
														</div>
													</div>
												</div>
												<div class="form-group">
