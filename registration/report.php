    ...
    <div class="container">
        <div class="register-box">
            <div class="register-logo">
                <a href="<?php echo BASE_URL; ?>reports/<?php echo $empDATA['emp_code']; ?>/"><b>Employee Payroll</b> Management</a>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <p><?php echo $empDATA['designation']; ?></p>
                    </div>
                </div>
                
                <hr />
                <div class="row">
                    <label class="col-sm-3">Bank A/C</label>
                    <div class="col-sm-9">
                        <p><?php echo ucwords($empDATA['bank_name']); ?>  /  <?php echo ucwords($empDATA['branch_name']); ?> / <?php echo ucwords($empDATA['account_no']); ?></p>
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-3">EPF A/C No.</label>
                    <div class="col-sm-9">
                        <p><?php echo $empDATA['epf_account']; ?></p>
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-3">ETF A/C No.</label>
                    <div class="col-sm-9">
                        <p><?php echo $empDATA['etf_account']; ?></p>
                    </div>
                </div>
                <div class="row">
