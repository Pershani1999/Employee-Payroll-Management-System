	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<?php if ( $_SESSION['Login_Type'] == 'admin' ) { ?>
				...
				<li class="<?php echo $page_name == "loans" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>loans/">
						<i class="fa fa-sign-out"></i> <span>Loan Management</span>
					</a>
				</li>
				<li></li>
				<li class="<?php echo $page_name == "advances" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>advances/">
						<i class="fa fa-sign-out"></i> <span>Advance Management</span>
					</a>
				</li>
				...
				<li class="<?php echo $page_name == "designations" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>designations/">
					<i class="fa fa-list"></i> <span>Designations List</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "payments" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>payments/">
					<i class="fa fa-check"></i><span>Payments</span>
					</a>
				</li>
			...
			<?php } else { ?>
				...
				<li class="<?php echo $page_name == "loans" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>loans/">
						<i class="fa fa-sign-out"></i> <span>Loans</span>
					</a>
				</li>
				<li class="<?php echo $page_name == "advances" ? 'active' : ''; ?>">
					<a href="<?php echo BASE_URL; ?>advances/">
						<i class="fa fa-sign-out"></i> <span>Advances</span>
					</a>
				</li>
